...
//        System.out.println(new Q300_LongestIncreasingSubsequence().lengthOfLIS1(new int[]{2,2}));
//        System.out.println(new Q300_LongestIncreasingSubsequence().lengthOfLIS1(new int[]{10,9,2,5,3,7,101,18}));

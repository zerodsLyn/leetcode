...
//        System.out.println(Arrays.toString(new Q_MinKNums().getLeastNumbers(new int[]{3,2,1}, 2)));
//        System.out.println(Arrays.toString(new Q_MinKNums().getLeastNumbers(new int[]{0,1,2,1}, 1)));
//        System.out.println(Arrays.toString(new Q_MinKNums().getLeastNumbers(new int[]{0,1,2,1}, 2)));
//        System.out.println(Arrays.toString(new Q_MinKNums().getLeastNumbers(new int[]{0,1,2,1}, 3)));
//        System.out.println(Arrays.toString(new Q_MinKNums().getLeastNumbers(new int[]{0,1,2,1}, 4)));
    }
}
